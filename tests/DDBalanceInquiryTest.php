...
class DDBalanceInquiryTest extends TestCase
{
    private $snap;
...
-----END PUBLIC KEY-----";
    ...
    protected function setUp(): void
    {
        ...
        $this->additionalInfo = new BalanceInquiryAdditionalInfoRequestDto(
    ...
    public function testShouldValidateSuccessfullyWithValidData()
    {
        ...
        $validData = new BalanceInquiryRequestDto(
            $this->additionalInfo
        );
        $this->assertNull($validData->validateBalanceInquiryRequestDto());
    }
    public function testShouldThrowErrorWhenChannelIsMissing()
    {
        ...
        $validData->validateBalanceInquiryRequestDto();
    }
