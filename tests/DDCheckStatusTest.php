...
class DDCheckStatusTest extends TestCase
{
    private $snap;
...
-----END PUBLIC KEY-----";
    ...
    protected function setUp(): void
    {
        ...
        $this->additionalInfo = new CheckStatusAdditionalInfoRequestDto(
            'device id',
    ...
    public function testShouldValidateSuccessfullyWithValidData()
    {
        ...
        $validData = new CheckStatusRequestDto(
            "123234234234234",
            "12323423423423",
            "3234234234234",
            "55",
        ...
        $this->assertNull($validData->validateCheckStatusRequestDto());
    }
    public function testShouldThrowErrorWhenChannelIsMissing()
    {
        $this->expectExceptionMessage("Service Code is required");
        $validData = new CheckStatusRequestDto(
            "123234234234234",
            "12323423423423",
            "3234234234234",
        ...
        $validData->validateCheckStatusRequestDto();
    }
